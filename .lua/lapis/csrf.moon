...
generate_token = (req, data) ->
  ...
  unless key
    -- LAPISBEAN PATCH: use GetRandomBytes instead of openssl.rand
    -- it might be less secure but we don't have access to a CSPRNG in redbean
    key = encode_base64 GetRandomBytes(32)
